...
- **[VerdictSwarm](https://github.com/sentien-labs/verdictswarm-mcp)** [![sentien-labs/verdictswarm-mcp MCP server](https://glama.ai/mcp/servers/sentien-labs/verdictswarm-mcp/badge)](https://glama.ai/mcp/servers/sentien-labs/verdictswarm-mcp) - Fight AI with AI. 6 adversarial AI agents independently analyze and debate crypto token risk before reaching consensus. Rug pull detection, security audits, holder analysis. Supports Solana, Ethereum, Base, BSC. Free tier, no API key needed.
