...
- **[VerdictSwarm](https://github.com/sentien-labs/verdictswarm-mcp)** - 6 AI agents independently analyze and debate crypto token risk before reaching consensus. Rug pull detection, security audits, holder analysis. Supports Solana, Ethereum, Base, BSC. Free tier, no API key needed.
